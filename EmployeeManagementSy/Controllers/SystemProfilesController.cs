...
namespace EmployeeManagementSy.Controllers
{
    public class SystemProfilesController : Controller
    {
        ...
        {
            if (id == null || _context.SystemProfiles == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create( SystemProfile systemProfile)
        {
                ...
                systemProfile.CreatedById = "Micro Code";
        ...
        {
            if (_context.SystemProfiles == null)
            {
                return Problem("Entity set 'ApplicationDbContext.SystemProfiles'  is null.");
            }
            var systemProfile = await _context.SystemProfiles.FindAsync(id);
            if (systemProfile != null)
            {
        ...
        {
          return (_context.SystemProfiles?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
