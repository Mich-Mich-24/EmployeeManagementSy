...
namespace EmployeeManagementSy.Controllers
{
    public class SystemCodeDetailsController : Controller
    {
        ...
        {
            if (id == null || _context.SystemCodesDetail == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.SystemCodesDetail == null)
            {
                return Problem("Entity set 'ApplicationDbContext.SystemCodesDetail'  is null.");
            }
            var systemCodeDetail = await _context.SystemCodesDetail.FindAsync(id);
            if (systemCodeDetail != null)
            {
        ...
        {
            return (_context.SystemCodesDetail?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
